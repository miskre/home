...
var props = {
  ...
  startingCountry: 'miskre-lab-1', // The key of the country to rotate the camera to during the introduction animation (and which country to start the cycle at)
  colours: {
    // Cache the colours
...
function returnCurveCoordinates(latitudeA, longitudeA, latitudeB, longitudeB) {
  ...
  multipleVal = multipleVal * 0.25
  // if (distance > 300) multipleVal = multipleVal * 0.2
